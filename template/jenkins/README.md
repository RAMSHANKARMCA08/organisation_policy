# Jenkins scan template

Runs Conftest against Jenkinsfile/Groovy pipeline files using the organization Jenkins opa policies. Usage:

```text
bash template/jenkins/scan.sh <repository-url> [output-directory]
```
