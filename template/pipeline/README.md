# Generic pipeline scan template

Scans GitHub Actions, Azure Pipeline, and Jenkins YAML/Groovy files with semgrep and Conftest where matching files exist. Usage:

```text
bash template/pipeline/scan.sh <repository-url> [output-directory]
```
