# Azure Pipelines scan template

Runs Conftest against Azure Pipeline YAML using the organization Azure Pipeline opa policies. Usage:

```text
bash template/azure/scan.sh <repository-url> [output-directory]
```
